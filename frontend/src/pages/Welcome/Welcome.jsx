    ...
    return(
        <div style={{maxWidth: "100%", height: "100%", margin: "0", padding:"0", }}>  
            <div class="px-4 py-5 my-5 text-center" style={{width: "100%"}}>
                <img class="d-block mx-auto mb-4" src="./src/res/logo.png" alt="" width="100" />
                ...
                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                    <a href=""><button type="button" class="btn btn-primary disabled">Admin</button></a>
                    <a href=""><button type="button" class="btn btn-success disabled">HOD</button></a>
